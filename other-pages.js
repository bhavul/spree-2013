$("document").ready(function(){
	...
	$("#slider ul li img").hover(function(){
	 ...
	 $("#nav ul li").hover(function() {
		 $(this).animate({right:'105px'});}, function() {
	...
	/* ------------------ */
	 ...
	 /*-----TICKER-------*/
	  $('#js-news').ticker({displayType:'fade'});
		 ...
		 /* --------------scroll bar with visibility thing ----- */

	  	var $el = $("#maintext").jScrollPane({hijackInternalLinks:true}),
...
/* ---------------------- */
 $(".fancybox").fancybox({aspectRatio:'true', nextClick:'true', nextEasing:'swing' });
